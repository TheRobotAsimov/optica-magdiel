                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="group">
                      ...
                      <input type="text" name="folio" value={formData.folio} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                        fieldErrors.folio
                    ...
                    <div className="group">
                      ...
                      <select name="idasesor" value={formData.idasesor} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                    ...
                    <div className="group">
                      ...
                      <input type="text" name="institucion" value={formData.institucion} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="group">
                    ...
                    <input type="text" name="uso_de_lente" value={formData.uso_de_lente} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                  ...
                  <div className="group">
                    ...
                    <select name="idoptometrista" value={formData.idoptometrista} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                  ...
                  <div className="group">
                    ...
                    <select name="examenSeguimientoOption" value={examenSeguimientoOption} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                  ...
                  <div className="group">
                    ...
                    <select name="kit" value={formData.kit} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                      fieldErrors.kit
                        ? 'border-red-500 focus:ring-red-100 bg-red-50'
                        : 'border-gray-200 focus:ring-blue-100 focus:border-blue-500 hover:border-gray-300'
                    }`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:col-span-3">
                    <div className="group">
                      ...
                      <select name="material" value={formData.material} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                    ...
                    {formData.material && (
                      <div className="group">
                        ...
                        <select name="tratamiento" value={formData.tratamiento} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                    ...
                    {formData.tratamiento && (
                      <div className="group">
                        ...
                        <select name="tipo_de_lente" value={formData.tipo_de_lente} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                    ...
                    {formData.tipo_de_lente && (
                      <div className="group">
                        ...
                        <select name="subtipo" value={formData.subtipo} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                          fieldErrors.subtipo
                            ? 'border-red-500 focus:ring-red-100 bg-red-50'
                            : 'border-gray-200 focus:ring-blue-100 focus:border-blue-500 hover:border-gray-300'
                        }`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:col-span-3">
                    <div className="group">
                      ...
                      <input type="text" name="tinte_color" value={formData.tinte_color} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                    ...
                    {formData.tinte_color && (
                        <div className="group">
                          ...
                          <select name="tono" value={formData.tono} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                            fieldErrors.tono
                              ? 'border-red-500 focus:ring-red-100 bg-red-50'
                              : 'border-gray-200 focus:ring-blue-100 focus:border-blue-500 hover:border-gray-300'
                          }`}>
                      ...
                      {formData.tono && (
                        <div className="group">
                          ...
                          <select name="desvanecido" value={formData.desvanecido} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                  ...
                  <div className="group">
                    ...
                    <select name="procesado" value={formData.procesado} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 bg-gray-100 ${
                  ...
                  {formData.tipo_de_lente === 'Bifocal' && (
                    <div className="group">
                      ...
                      <select name="blend" value={formData.blend} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                        fieldErrors.blend
                          ? 'border-red-500 focus:ring-red-100 bg-red-50'
                          : 'border-gray-200 focus:ring-blue-100 focus:border-blue-500 hover:border-gray-300'
                      }`}>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-100">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                   <div className="group">
                     ...
                     <select name="tipo" value={formData.tipo} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                       fieldErrors.tipo
                         ? 'border-red-500 focus:ring-red-100 bg-red-50'
                         : 'border-gray-200 focus:ring-blue-100 focus:border-blue-500 hover:border-gray-300'
                     }`}>
                   ...
                   <div className="group">
                     ...
                     <input type="number" name="enganche" value={formData.enganche} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                   ...
                   <div className="group">
                     ...
                     <input type="number" name="cant_pagos" value={formData.cant_pagos} onChange={handleChange} onBlur={handleBlur} className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                   ...
                   <div className="group">
                     ...
                     <input type="date" name="fecha_entrega" value={formData.fecha_entrega} onChange={handleChange} onBlur={handleBlur} required className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-4 transition-all duration-200 ${
                   ...
                   <div className="group">
                     ...
                     <button
                       ...
                       className={`w-full px-3 py-2 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 ${
                         priceIncreaseReason
